...
public class GameSessionShould {
    ...
    @Test
    public void register_client_to_desired_raspberry_pi() throws HardwareOccupiedException {
    ...
    @Test
    public void notify_that_the_desired_raspberry_pi_is_already_in_use() throws HardwareOccupiedException {
        GameSession session = new GameSession();
        int raspBerryPiId = 1;
        int clientId = 1;
        session.registerRaspberryPiWith(raspBerryPiId);
        ...
        HardwareOccupiedException actual = assertThrows(HardwareOccupiedException.class, () ->
                session.registerClientToDesiredRaspberryWith(raspBerryPiId, clientId));
